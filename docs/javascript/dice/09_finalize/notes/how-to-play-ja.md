...
一度確定させた役は変更不可能になります、後のターンでより高得点になる場合でも、変更不可能です。

役表全てが埋まる 13 ターンでゲームは終了、その時のスコアが高い方が勝者です。

![13個のダイス値を、役表に当てはめて得点を算出している図](./images/play-instruction-02-ja.png)

役表にはダイスによる役とは別に、**セクションボーナス**というものがあります。これは**役前方の合計値が63点以上**のときに成立し、その場合 35 点が加算されます。
